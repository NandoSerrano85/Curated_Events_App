...
// Fetch events with regular pagination
export const useEvents = (query: any = {}, enabled = true) => {
  return useQuery({
...
// Fetch events with infinite pagination
export const useInfiniteEvents = (query: SearchQuery = {}, enabled = true) => {
  return useInfiniteQuery({
    queryKey: [...eventKeys.list(query), 'infinite'],
